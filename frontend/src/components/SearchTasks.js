...
import styles from "../styles/SearchTasks";
...
const TaskSearchScreen = () => {
  ...
  const [standAloneTask, setStandAloneTask] = useState(false);
        ...
        <View style={styles.container}>
          ...
          >
            ...
            >
              ...
              <Text style={styles.label}>Date Quick Filters</Text>
              ...
              <Text style={styles.label}>Goal Association Quick Filters</Text>
              <View style={styles.checkboxContainer}>
                <View style={styles.checkboxRow}>
                  <Text
                    style={[
                      styles.checkboxLabel,
                      hasGoal && { color: "#ffffff" },
                    ]}
                  >
                    Has Goal Association
                  </Text>
                  <Checkbox
                    color={"#cf59a9"}
                    value={hasGoal}
                    onValueChange={() =>
                      toggleCheckbox(setHasGoal, [setStandAloneTask])
                    }
                  />
                </View>
                ...
                <View style={[styles.checkboxRow, { marginBottom: 0 }]}>
                  <Text
                    style={[
                      styles.checkboxLabel,
                      standAloneTask && { color: "#ffffff" },
                    ]}
                  >
                    Has No Goal Association
                  </Text>
                  <Checkbox
                    color={"#cf59a9"}
                    value={standAloneTask}
                    onValueChange={() =>
                      toggleCheckbox(setStandAloneTask, [setHasGoal])
                    }
                  />
                </View>
              </View>
